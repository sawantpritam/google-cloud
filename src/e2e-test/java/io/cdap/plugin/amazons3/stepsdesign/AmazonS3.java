...
import static io.cdap.plugin.utils.GCConstants.ERROR_MSG_AMAZON_INVALID_PATH;
import static io.cdap.plugin.utils.GCConstants.ERROR_MSG_AMAZON_INVALID_PATH_FIELD;
...
public class AmazonS3 implements CdfHelper {
  ...
  public void enterTheGCSProperties() throws InterruptedException, IOException {
    ...
    CdfGcsActions.getGcsBucket(CdapUtils.pluginProp("amazonGcsBucketName"));
  ...
  public void enterTheAmazonProperties() throws InterruptedException, IOException {
    ...
    AmazonS3Actions.enterReferenceName(CdapUtils.pluginProp("referenceName"));
    AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp("bucketPath"));
  ...
  public void enterTheAmazonPropertiesForBucket(String path) {
    AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp(path));
  ...
  public void enterTheAmazonPropertiesWithBlankProperty(String property) {
    if (property.equalsIgnoreCase("referenceName")) {
      AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp("amazonPath"));
  ...
  public void enterTheAmazonPropertiesWithIncorrectPropertyValue(String field, String value) {
    if (field.equalsIgnoreCase("path")) {
      AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp(value));
      AmazonS3Actions.enterReferenceName("Amazon" + UUID.randomUUID().toString());
    } else if (field.equalsIgnoreCase("Maximum Split Size")) {
      SeleniumHelper.replaceElementValue(AmazonS3Locators.maximumSplitSize, CdapUtils.pluginProp(value));
      AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp("amazonPath"));
      AmazonS3Actions.enterReferenceName("Amazon" + UUID.randomUUID().toString());
    } else if (field.equalsIgnoreCase("Path Field ")) {
      SeleniumHelper.replaceElementValue(AmazonS3Locators.pathField, CdapUtils.pluginProp(value));
      AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp("amazonPath"));
      AmazonS3Actions.enterReferenceName("Amazon" + UUID.randomUUID().toString());
    }
  }
  ...
  public void validateIncorrectPropertyErrorForTableValue(String property, String value) {
    ...
    if (property.equalsIgnoreCase("dataset")) {
      tableFullName = CdapUtils.pluginProp("projectId") + ":" + CdapUtils.pluginProp(value)
        + "." + CdapUtils.pluginProp("amazonBqTableName");
  ...
  public void enterTheAmazonPropertiesForBucketAndFormatWithDelimiterField
    ...
    AmazonS3Actions.selectFormat(CdapUtils.pluginProp(format));
  ...
  public void enterTheAmazonPropertiesForBucketAndPathFieldWithPathFileNameOnlySet
    ...
    AmazonS3Actions.enterPathField(CdapUtils.pluginProp(field));
  ...
  public void enterTheAmazonPropertiesForBucketAndRegexFilter(String path, String regexFilter) {
    enterTheAmazonPropertiesForBucket(path);
    AmazonS3Actions.enterRegexFilter(CdapUtils.pluginProp(regexFilter));
  }
  ...
  public void verifyInvalidAmazonBucketPathError() {
    CdfStudioActions.clickValidateButton();
    String expectedErrorMessage = CdapUtils.errorProp(ERROR_MSG_AMAZON_INVALID_PATH);
  ...
  public void enterTheAmazonPropertiesWithBlankAuthenticationFields(String authenticationMethod) {
    if (authenticationMethod.equalsIgnoreCase("accessID")) {
      AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp("amazonRecursiveDataPath"));
      AmazonS3Actions.enterReferenceName("Amazon" + UUID.randomUUID().toString());
      AmazonS3Actions.accessKey(CdapUtils.pluginProp("accessKey"));
    } else if (authenticationMethod.equalsIgnoreCase("accessKey")) {
      AmazonS3Actions.enterBucketPath(CdapUtils.pluginProp("amazonRecursiveDataPath"));
      AmazonS3Actions.enterReferenceName("Amazon" + UUID.randomUUID().toString());
      AmazonS3Actions.accessID(CdapUtils.pluginProp("accessID"));
    }
  }
  ...
  public void enterTheAmazonPropertiesForBucketAndIncorrectSplitSize(String path, String value) {
    enterTheAmazonPropertiesForBucket(path);
    AmazonS3Actions.enterMaxSplitSize(CdapUtils.pluginProp(value));
  }
  ...
  public void verifyInvalidSplitSizeError() {
    CdfStudioActions.clickValidateButton();
    String expectedErrorMessage = CdapUtils.errorProp(ERROR_MSG_ERROR_FOUND_VALIDATION);
    String actualErrorMessage = CdapUtils.findPropertyErrorElement("maxSplitSize").getText();
    Assert.assertEquals(expectedErrorMessage, actualErrorMessage);
    String actualColor = CdapUtils.getErrorColor(CdapUtils.findPropertyErrorElement("maxSplitSize"));
    String expectedColor = CdapUtils.errorProp(ERROR_MSG_COLOR);
    Assert.assertEquals(expectedColor, actualColor);
  ...
  public void enterTheAmazonPropertiesForBucketAndSelectingFileEncoding(String path, String encoding)
    throws InterruptedException {
    enterTheAmazonPropertiesForBucket(path);
    AmazonS3Actions.fileEncoding(CdapUtils.pluginProp(encoding));
  }
  ...
  public void enterTheAmazonPropertiesForBucketAndIncorrectPathField(String path, String pathfield) {
    enterTheAmazonPropertiesForBucket(path);
    AmazonS3Actions.enterPathField(CdapUtils.pluginProp(pathfield));
  }

  @Then("Verify invalid path field error")
  public void verifyInvalidPathFieldError() {
    CdfStudioActions.clickValidateButton();
    String expectedErrorMessage = CdapUtils.errorProp(ERROR_MSG_AMAZON_INVALID_PATH_FIELD);
