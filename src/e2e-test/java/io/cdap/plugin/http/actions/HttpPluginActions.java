...
import static io.cdap.plugin.utils.E2ETestConstants.ERROR_MSG_HTTP_OAUTH_VALIDATION;
...
public class HttpPluginActions {
  ...
  public static void validateOAuthPropertyError(String property) {
    String expectedErrorMessage = E2ETestUtils.errorProp(ERROR_MSG_HTTP_OAUTH_VALIDATION)
